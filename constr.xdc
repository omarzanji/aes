...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {correct_flag}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {correct_flag}]
set_property PACKAGE_PIN E19 [get_ports {status[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status[0]}]
set_property PACKAGE_PIN U19 [get_ports {status[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status[1]}]
set_property PACKAGE_PIN V19 [get_ports {status[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status[2]}]
set_property PACKAGE_PIN W18 [get_ports {status[3]}]					
...
##USB-RS232 Interface
set_property PACKAGE_PIN B18 [get_ports r_Rx_Serial]						
